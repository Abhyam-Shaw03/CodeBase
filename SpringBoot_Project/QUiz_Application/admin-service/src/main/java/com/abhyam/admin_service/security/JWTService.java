...
public class JWTService {
    ...
    // THE BELOW GIVEN METHODS ARE TO EXTRACT USERNAME AND CLAIMS(includes requests that were sent along with the token) FROM THE TOKEN.
    ...
    public boolean validateToken(String token, UserDetails userDetails) {
        ...
        return (adminName.equals(userDetails.getUsername()) && !isTokenExpired(token));
    }
